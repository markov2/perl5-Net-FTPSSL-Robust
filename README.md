# Net::FTPSSL::Robust
  ...
  * Development via GitHub: <https://github.com/markov2/perl5-Net-FTPSSL-Robust>
  * Download from CPAN: <ftp://ftp.cpan.org/pub/CPAN/authors/id/M/MA/MARKOV/>
  * Indexed from CPAN: <http://search.cpan.org/~markov/Net-FTPSSL-Robust/>
    and <https://metacpan.org/release/Net-FTPSSL-Robust>
...
module implements retries on top of Net::FTPSSL.

Also see Net::FTP::Robust.
